...
The R-squared value for the ridge regression model on the testing data outputs to be 82.79%, which is a slight decrease in performance compared with the linear regression model at a R-squared value of 82op%.
